	                        ...
	                        <div class="form-group">
		                		...
		                		<div class="col-md-12">
			                        <label class="checkbox checkbox-custom">
		                                <input name="format" type="radio" value="news" {{ $category->format == 'news' ? 'checked=checked' : ''}}><i></i> News
		                            </label>
			                        <label class="checkbox checkbox-custom">
		                                <input name="format" type="radio" value="motorbike" {{ $category->format == 'motorbike' ? 'checked=checked' : ''}}><i></i> Motorbike
		                            </label>
			                        <label class="checkbox checkbox-custom">
		                                <input name="format" type="radio" value="gallery" {{ $category->format == 'gallery' ? 'checked=checked' : ''}}><i></i> Gallery
		                            </label>
