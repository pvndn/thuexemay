	...
	<div class="page">
		...
		<section class="tile">
	        ...
	        <div class="tile-header dvd dvd-btm">
	            <h1 class="custom-font"><strong>Pages</strong> List</h1>
	            <ul class="controls">
	                <li>
	                    <a role="button" tabindex="0" href="{{ route('admin.page.create') }}"><i class="fa fa-plus mr-5"></i> Add page</a>
	                </li>
	                <li class="dropdown">
		                    ...
		                    <tr class="odd gradeX">
		                        ...
		                        <td>
		                        	<div class="onoffswitch labeled blue inline-block">
                                        <input type="checkbox" name="publish" cate-id={{ $page->id }} class="onoffswitch-checkbox" id="switch{{ $page->id }}" {{ ($page->publish == 0) ? 'checked' : '' }}>
